...
class ConstructSample:
    ...
    def make_reward(self, folder, i):
        ...
        try:
            ...
            if(self.cnt_round == 1):
                print("aaaaaaaaa")
                print("this is the second round")
                print("next is list_samples")
                print(list_samples)
            ...
            if(self.cnt_round == 1):
                print("aaaaaaaaa")
                print("this is the second round")
                print("next is samples_all_intersection")
                print(self.samples_all_intersection)
            return 1
        except Exception as e:
    ...
    def make_reward_for_system(self):
        ...
        for folder in os.listdir(self.path_to_samples):
            # path_to_samples = train_round/round_cnt_round/
            # folder = generator_0
